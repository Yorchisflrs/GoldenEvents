...
<?php foreach ($audit['items'] as $item): ?><tr><td><?php echo htmlspecialchars($item['created_at'], ENT_QUOTES, 'UTF-8'); ?></td><td><?php echo htmlspecialchars($item['administrador_nombre'], ENT_QUOTES, 'UTF-8'); ?><br><?php echo htmlspecialchars($item['administrador_email'], ENT_QUOTES, 'UTF-8'); ?></td><td><?php echo htmlspecialchars($item['accion'], ENT_QUOTES, 'UTF-8'); ?></td><td><?php echo htmlspecialchars($item['entidad'], ENT_QUOTES, 'UTF-8'); ?> #<?php echo (int) $item['entidad_id']; ?></td><td><small><?php echo htmlspecialchars($item['detalles'] ?? '-', ENT_QUOTES, 'UTF-8'); ?></small></td><td><?php echo htmlspecialchars($item['direccion_ip'] ?? '-', ENT_QUOTES, 'UTF-8'); ?></td></tr><?php endforeach; ?>
